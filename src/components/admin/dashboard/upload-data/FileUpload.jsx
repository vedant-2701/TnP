...
import { FileSpreadsheet, UploadCloud, X, Check, AlertCircle, Loader2 } from 'lucide-react';
      ...
      <div className="w-1/3">
        ...
        {file && uploadState.status === 'idle' && (
          <button
            ...
            className="mt-4 w-full bg-gradient-to-b from-blue-300 to-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-600 transition-colors duration-300 animate-[fadeIn_0.3s_ease-in-out] flex items-center justify-center space-x-2"
          >
