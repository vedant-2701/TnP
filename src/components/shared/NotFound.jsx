...
import { notFound, notFoundCleanUp } from "../../helper/notFound";
...
export default function NotFound() {
    ...
    useEffect(() => {
        notFound();
        // return notFoundCleanUp();
    }, []);

    return (
        <div className="container mx-auto w-[30%] md:w-[50%] lg:w-[70%]">
            <div className="flex justify-center items-center mt-5 mb-5 row">
                <svg
                    width="100%"
                    // height="auto"
                    viewBox="0 0 636 324"
